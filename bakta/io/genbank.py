        ...
        for feature in features:
            if(feature['contig'] == contig['id']):
                ...
                if(feature_type == bc.FEATURE_ORIC) or (feature_type == bc.FEATURE_ORIT) or (feature_type == bc.FEATURE_ORIV):
                    ...
                    qualifiers['strand'] = feature['strand']
                    ...
                    if(feature['type'] == bc.FEATURE_CDS) or (feature_type == bc.FEATURE_SORF):
                        ...
                        if('notes' in feature):
                            if('anti_codon' in feature):
                                ...
                                qualifiers['anticodon'] = f"(aa:{feature['notes'][-10:-7]},seq:{feature['anti_codon'].lower()})"
                            else:
                                qualifiers['anticodon'] = f"(seq:{feature['anti_codon'].lower()})"
                        ...
                        insdc_feature_type = bc.INSDC_FEATURE_MISC_FEAURE

                strand_dir = +1 if feature['strand'] == bc.STRAND_FORWARD else -1
