...
DEPENDENCY_PYRODIGAL = (Version(3, 1, 0), Version(VERSION_MAX_DIGIT, VERSION_MAX_DIGIT, VERSION_MAX_DIGIT), VERSION_REGEX, 'Pyrodigal', ('python', '-c', 'import pyrodigal; print(pyrodigal.__version__)'), ['--skip-cds'])
