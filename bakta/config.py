...
def setup(args):
    ...
    # input / output configurations
    global min_contig_length, output, prefix, tsv, gff3, genbank, embl, faa
    ...
    global skip_trna, skip_tmrna, skip_rrna, skip_ncrna, skip_ncrna_region, skip_crispr, skip_cds, skip_sorf, skip_gap
