...
def setup(args):
    ...
    global skip_trna, skip_tmrna, skip_rrna, skip_ncrna, skip_ncrna_region, skip_crispr, skip_cds, pseudo, skip_sorf, skip_gap, skip_ori
    ...
    pseudo = args.pseudo
    log.info('predict-pseudo=%s', pseudo)
