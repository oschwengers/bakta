    ...
    try:
        ...
        with sqlite3.connect("file:%s?mode=ro" % str(config['db'].joinpath('ups.db')), uri=True) as conn:
            ...
            for feature in features:
                ...
                if(rec is not None):
                    ups = {
                        'uniref90_id': bc.DB_PREFIX_UNIREF_90 + rec[DB_UPS_COL_UNIREF90],
                        'uniref100_id': bc.DB_PREFIX_UNIREF_100 + rec[DB_UPS_COL_UNIREF100],
                        'uniparc_id': bc.DB_PREFIX_UNIPARC + rec[DB_UPS_COL_UNIPARC],
                        'refseq_nrp_id': bc.DB_PREFIX_REFSEQ_NRP + rec[DB_UPS_COL_REFSEQ_NRP],
