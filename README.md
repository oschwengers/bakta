...
Often, the usage of Bakta is a necessary upfront task followd by deeper analyses implemented in custom scripts. In (scripts) we'd like to collect & offer a pool of scripts addressing common tasks:
