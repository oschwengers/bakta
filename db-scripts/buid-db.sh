...
printf "\n1/10: download rRNA covariance models from Rfam ...\n"
mkdir Rfam
cd Rfam
...
printf "\n2/10: download ncRNA gene covariance models from Rfam ...\n"
...
printf "\n2/10: download ncRNA region covariance models from Rfam ...\n"
...
printf "\n3/10: download NCBI Taxonomy DB ...\n"
mkdir taxonomy
cd taxonomy
...
############################################################################
printf "\n9/10: download AMR gene WP_* annotations from NCBI Pathogen AMR db ...\n"
...
############################################################################
printf "\n10/10: download ISfinder protein sequences ...\n"
