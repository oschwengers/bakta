...
printf "\n2/16: download ncRNA gene covariance models from Rfam ...\n"
...
printf "\n3/16: download ncRNA region covariance models from Rfam ...\n"
...
printf "\n5/16: download and extract oriT sequences from Mob-suite ...\n"
wget https://zenodo.org/record/3786915/files/data.tar.gz
tar -xvzf data.tar.gz
mv data/orit.fas ./orit.fna
rm -r data/ data.tar.gz
printf "\n5/16: download and extract oriC sequences from DoriC ...\n"
...
############################################################################
printf "\n14/16: download ISfinder protein sequences ...\n"
wget https://raw.githubusercontent.com/oschwengers/ISfinder-sequences/2e9162bd5e3448c86ec1549a55315e498bef72fc/IS.faa
printf "\n14/16: annotate IPSs ...\n"
...
############################################################################
printf "\n16/16: download AA sequences for expert annotation system ...\n"
