...
printf "\n5/13: download NCBI Taxonomy DB ...\n"
mkdir taxonomy
cd taxonomy
...
############################################################################
printf "\n7/13: download UniProt UniRef100 ...\n"
...
printf "\n7/13: read, filter and store UniRef100 entries ...:\n"
...
############################################################################
printf "\n8/13: download UniProt UniRef90 ...\n"
wget -nv ftp://ftp.expasy.org/databases/uniprot/current_release/uniref/uniref90/uniref90.xml.gz
printf "\n8/13: read UniRef90 entries and build Protein Sequence Cluster sequence and information databases:\n"
...
############################################################################
printf "\n9/13: download RefSeq nonredundant proteins and clusters ...\n"
...
############################################################################
printf "\n12/13: download AMR gene WP_* annotations from NCBI Pathogen AMR db ...\n"
...
############################################################################
printf "\n13/13: download ISfinder protein sequences ...\n"
