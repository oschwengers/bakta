...
printf "\n1/17: download rRNA covariance models from Rfam ...\n"
...
printf "\n2/17: download ncRNA gene covariance models from Rfam ...\n"
...
printf "\n3/17: download ncRNA region covariance models from Rfam ...\n"
...
printf "\n4/17: download and extract spurious ORF HMMs from AntiFam ...\n"
mkdir antifam-dir
cd antifam-dir
...
printf "\n5/17: download and extract oriT sequences from Mob-suite ...\n"
wget https://zenodo.org/record/3786915/files/data.tar.gz
tar -xvzf data.tar.gz
mv data/orit.fas ./orit.fna
rm -r data/ data.tar.gz
printf "\n5/17: download and extract oriC sequences from DoriC ...\n"
...
printf "\n6/17: download NCBI Taxonomy DB ...\n"
mkdir taxonomy
cd taxonomy
...
############################################################################
printf "\n14/17: download AMR gene WP_* annotations from NCBI Pathogen AMR db ...\n"
...
############################################################################
printf "\n15/17: download ISfinder protein sequences ...\n"
...
############################################################################
printf "\n16/17: download HMM models from Pfam ...\n"
...
############################################################################
printf "\n17/17: download AA sequences for expert annotation system ...\n"
